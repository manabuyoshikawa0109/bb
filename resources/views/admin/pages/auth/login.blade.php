                ...
                <div class="card-body">
                    ...
                    <div class="app-brand justify-content-center">
                        <a href="{{ route('admin.login') }}" class="app-brand-link gap-2">
                            ...
                            <span class="app-brand-text demo text-body fw-bolder">BBテニス</span>
                        </a>
                    </div>
                    <!-- /Logo -->
                    <h4 class="mb-2">Welcome to BB tennis! 👋</h4>
                    ...
                    <form id="formAuthentication" class="mb-3" action="{{ route('admin.login.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            @include('admin.commons.components.html.text', ['id' => 'email', 'fieldName' => "email", 'placeholder' => 'メールアドレスを入力してください'])
                        </div>
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="remember-me" name="remember" value="1" @if(old('remember') === '1') checked @endif/>
